...
The script detects common macOS/Linux fonts. Supply `--font` and `--piece-font` if needed; the piece font must contain the ♞ glyph. Images are generated locally. Commit the updated files in `assets/` to update the profile.
